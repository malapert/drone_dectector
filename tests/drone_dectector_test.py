...
def test_name():
    name = drone_dectector.__name_soft__
    assert name == "drone_dectector"
...
def test_new_level():
    drone_dectector.custom_logging.UtilsLogs.add_logging_level("TRACE", 20)
...
def test_message():
    record = drone_dectector.custom_logging.LogRecord(
        "__main__",
        logging.INFO,
        "pathname",
        2,
...
def test_color_formatter():
    formatter = drone_dectector.custom_logging.CustomColorFormatter()
    logger = logging.getLogger("drone_dectector.custom_logging")
    ...
    shell_formatter = drone_dectector.custom_logging.ShellColorFormatter()
    record = drone_dectector.custom_logging.LogRecord(
        "__main__",
        logging.INFO,
        "pathname",
